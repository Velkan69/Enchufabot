...
if (!isGroup && !isCmd && !command && !mek.key.fromMe && !autorespon) {
	simi = await fetchJson(`https://api.simsimi.net/v1/?lang=id&cf=false&text=${budy}`)
                     sami = simi.success
...
│
└───「 \`\`\`${NamaBot}\`\`\` 」`
  buttons = [{buttonId:`${prefix}command`,buttonText:{displayText:'LIST MENU'},type:1},{buttonId:`${prefix}owner`,buttonText:{displayText:'DEVELOPER'},type:1},{buttonId:`${prefix}script`,buttonText:{displayText:'SOURCE CODE'},type:1}]
